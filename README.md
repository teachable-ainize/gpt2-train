...
```
$ curl --request GET 'https://train-2tr44yh9v3fw3qii6c53-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-2tr44yh9v3fw3qii6c53-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-3-ko-6B-finetune' \
