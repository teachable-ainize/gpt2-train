...
```
$ curl --request GET 'https://train-mxysk1opgrzauh8ifw55-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-mxysk1opgrzauh8ifw55-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/bart-ko-small-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
