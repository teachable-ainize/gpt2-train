...
```
$ curl --request GET 'https://train-b7qsbhx40at2o2ji1xn3-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-b7qsbhx40at2o2ji1xn3-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/xangle-summary' \
  --header 'Content-Type: application/json' \
  --data-raw '{
