...
```
$ curl --request GET 'https://train-mjheysrcbek1hk17w3dj-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-mjheysrcbek1hk17w3dj-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/deberta-en-base-pretrained-finetune-dev' \
  --header 'Content-Type: application/json' \
  --data-raw '{
