...
```
$ curl --request GET 'https://train-q7bpaa5rg0ooo9s3rht2-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-q7bpaa5rg0ooo9s3rht2-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-ko-small-finetune' \
