...
```
$ curl --request GET 'https://train-0bysmk6cwc8v3nxwr1ej-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-0bysmk6cwc8v3nxwr1ej-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-ko-small-finetune' \
