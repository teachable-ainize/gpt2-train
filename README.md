...
```
$ curl --request GET 'https://train-jicemttww21slbdidn0r-gpt2-train-teachable-ainize.endpoint.staging.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-jicemttww21slbdidn0r-gpt2-train-teachable-ainize.endpoint.staging.ainize.ai/predictions/gpt-2-en-small-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
