...
```
$ curl --request GET 'https://train-fn2eiftksl4lmujr00xk-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
#### New Listing
```
$ curl --request POST 'https://train-fn2eiftksl4lmujr00xk-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/predictions/xangle-summary' \
