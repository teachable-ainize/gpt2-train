...
```
$ curl --request GET 'https://train-wobnmfrmuzrttyxrbjch-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-wobnmfrmuzrttyxrbjch-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/distilbert-en-base-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
