...
```
$ curl --request GET 'https://train-m-mvq41s6v-q1yl-8p9s-kf-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-m-mvq41s6v-q1yl-8p9s-kf-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-en-medium-finetune' \
