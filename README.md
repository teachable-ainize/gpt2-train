...
```
$ curl --request GET 'https://train-zza9a6qdydjdq21bnu8t-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-zza9a6qdydjdq21bnu8t-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/deberta-en-base-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
