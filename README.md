...
```
$ curl --request GET 'https://train-m-mv-va-j5o-jo-tyw-q8fq-xd-o-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-m-mv-va-j5o-jo-tyw-q8fq-xd-o-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-en-large-finetune' \
