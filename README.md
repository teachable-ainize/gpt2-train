...
```
$ curl --request GET 'https://train-t3pxdi6h62f29n2zc1wz-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-t3pxdi6h62f29n2zc1wz-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/deberta-en-base-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
