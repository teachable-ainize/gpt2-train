...
```
$ curl --request GET 'https://train-kptmqbqil85uxflkdunp-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-kptmqbqil85uxflkdunp-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-3-ko-6B-finetune' \
