...
```
$ curl --request GET 'https://train-9yqy25ikkq03mtum3r39-gpt2-train-teachable-ainize.endpoint.staging.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-9yqy25ikkq03mtum3r39-gpt2-train-teachable-ainize.endpoint.staging.ainize.ai/predictions/gpt-2-en-medium-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
