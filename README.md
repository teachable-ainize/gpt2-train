...
```
$ curl --request GET 'https://train-ohiyg0hntej5nprnorpy-gpt2-train-teachable-ainize.endpoint.staging.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-ohiyg0hntej5nprnorpy-gpt2-train-teachable-ainize.endpoint.staging.ainize.ai/predictions/gpt-2-en-small-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
