...
```
$ curl --request GET 'https://train-1wbuxrd77ywfldccdhp0-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-1wbuxrd77ywfldccdhp0-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/deberta-en-base-pretrained-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
