...
```
$ curl --request GET 'https://train-beajb44engikj6vv6od4-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-beajb44engikj6vv6od4-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/xangle-summary' \
  --header 'Content-Type: application/json' \
  --data-raw '{
