...
```
$ curl --request GET 'https://train-d6g0vfnr64sgqq1o9735-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-d6g0vfnr64sgqq1o9735-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-en-large-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
