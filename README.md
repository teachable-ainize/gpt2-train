...
```
$ curl --request GET 'https://train-ki886nbwzhiojwctmyic-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
#### New Listing
```
$ curl --request POST 'https://train-ki886nbwzhiojwctmyic-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/predictions/xangle-summary' \
