...
```
$ curl --request GET 'https://train-m-mvvm-nr-e4d-hhud-dvy-jg-r-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-m-mvvm-nr-e4d-hhud-dvy-jg-r-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-en-medium-finetune' \
