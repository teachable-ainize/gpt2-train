...
```
$ curl --request GET 'https://train-ncq3fsop8sixhnb8759s-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-ncq3fsop8sixhnb8759s-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/deberta-en-base-finetune' \
  --header 'Content-Type: application/json' \
  --data-raw '{
