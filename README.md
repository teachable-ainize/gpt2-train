...
```
$ curl --request GET 'https://train-5ev1dtjkywaaz7eg0ihd-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-5ev1dtjkywaaz7eg0ihd-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/predictions/gpt-2-ko-small-finetune' \
