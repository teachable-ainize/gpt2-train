...
```
$ curl --request GET 'https://train-ykdyqxf8bfk8tj6qep4d-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-ykdyqxf8bfk8tj6qep4d-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-en-large-finetune' \
