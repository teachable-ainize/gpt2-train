...
```
$ curl --request GET 'https://train-j9chxhtqbrh11amyhxku-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
#### New Listing
```
$ curl --request POST 'https://train-j9chxhtqbrh11amyhxku-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/predictions/xangle-summary' \
