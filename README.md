...
```
$ curl --request GET 'https://train-6z2ebjy5ykixk9k20mup-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
#### New Listing
```
$ curl --request POST 'https://train-6z2ebjy5ykixk9k20mup-gpt2-train-teachable-ainize.endpoint.dev.ainize.ai/predictions/xangle-summary' \
