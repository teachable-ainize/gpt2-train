...
```
$ curl --request GET 'https://train-a9ff0s2n4uh2j2etrmgw-gpt2-train-teachable-ainize.endpoint.ainize.ai/ping'
{
  "status": "Healthy"
}
```
...
Using `curl` in the terminal:
```
$ curl --request POST 'https://train-a9ff0s2n4uh2j2etrmgw-gpt2-train-teachable-ainize.endpoint.ainize.ai/predictions/gpt-2-ko-small-finetune' \
